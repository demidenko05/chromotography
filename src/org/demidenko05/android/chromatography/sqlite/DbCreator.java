...
public class DbCreator {
	...
	public void createAndPopulate(SQLiteDatabase db) {
	    ...
	    columnPc.setId(OrmServicesFactory.getInstance().getOrmService(Column.class).insert(columnPc));
	    Column columnP100 = new Column(); columnP100.setName("Primesep 100");
	    columnP100.setId(OrmServicesFactory.getInstance().getOrmService(Column.class).insert(columnP100));
	    Column columnOblN = new Column(); columnOblN.setName("Obelisc N");
	    columnOblN.setId(OrmServicesFactory.getInstance().getOrmService(Column.class).insert(columnOblN));
	    //Detectors:
	    Detector detectUv = new Detector(); detectUv.setName("UV Detection");
	    detectUv.setId(OrmServicesFactory.getInstance().getOrmService(Detector.class).insert(detectUv));
	    Detector detectelsd = new Detector(); detectelsd.setName("ELSD Detection");
	    detectelsd.setId(OrmServicesFactory.getInstance().getOrmService(Detector.class).insert(detectelsd));
	    Detector detectMs = new Detector(); detectMs.setName("MS Detection");
	    detectMs.setId(OrmServicesFactory.getInstance().getOrmService(Detector.class).insert(detectMs));
	    //Analytes:
	    Analyte analyteBnz = new Analyte(); analyteBnz.setName("Benzoquinone");
	    analyteBnz.setId(OrmServicesFactory.getInstance().getOrmService(Analyte.class).insert(analyteBnz));
	    Analyte analyteBenzil = new Analyte(); analyteBenzil.setName("Benzylamine");
	    analyteBenzil.setId(OrmServicesFactory.getInstance().getOrmService(Analyte.class).insert(analyteBenzil));
	    Analyte analyteAcid = new Analyte(); analyteAcid.setName("Aspartic Acid");
	    analyteAcid.setId(OrmServicesFactory.getInstance().getOrmService(Analyte.class).insert(analyteAcid));
	    Analyte analyteSAcid = new Analyte(); analyteSAcid.setName("Succinic Acid");
	    analyteSAcid.setId(OrmServicesFactory.getInstance().getOrmService(Analyte.class).insert(analyteSAcid));
	    Analyte analytePhlm = new Analyte(); analytePhlm.setName("Phenylalanine");
	    analytePhlm.setId(OrmServicesFactory.getInstance().getOrmService(Analyte.class).insert(analytePhlm));
	    Analyte analytePhenol = new Analyte(); analytePhenol.setName("Phenol");
	    analytePhenol.setId(OrmServicesFactory.getInstance().getOrmService(Analyte.class).insert(analytePhenol));
	    Analyte analyteCaffeine = new Analyte(); analyteCaffeine.setName("Caffeine");
	    analyteCaffeine.setId(OrmServicesFactory.getInstance().getOrmService(Analyte.class).insert(analyteCaffeine));
	    Analyte anFumaricAcid = new Analyte(); anFumaricAcid.setName("Fumaric Acid");
	    anFumaricAcid.setId(OrmServicesFactory.getInstance().getOrmService(Analyte.class).insert(anFumaricAcid));
	    Analyte anHydroxybenzoicAcid = new Analyte(); anHydroxybenzoicAcid.setName("Hydroxybenzoic Acid");
	    anHydroxybenzoicAcid.setId(OrmServicesFactory.getInstance().getOrmService(Analyte.class).insert(anHydroxybenzoicAcid));
	    Analyte anMalicAcid = new Analyte(); anMalicAcid.setName("Malic Acid");
	    anMalicAcid.setId(OrmServicesFactory.getInstance().getOrmService(Analyte.class).insert(anMalicAcid));
	    Analyte anMandelicAcid = new Analyte(); anMandelicAcid.setName("Mandelic Acid");
	    anMandelicAcid.setId(OrmServicesFactory.getInstance().getOrmService(Analyte.class).insert(anMandelicAcid));
	    Analyte anMethylmalonicAcid = new Analyte(); anMethylmalonicAcid.setName("Methylmalonic Acid");
	    anMethylmalonicAcid.setId(OrmServicesFactory.getInstance().getOrmService(Analyte.class).insert(anMethylmalonicAcid));
	    Analyte anTartaricAcid = new Analyte(); anTartaricAcid.setName("Tartaric Acid");
	    anTartaricAcid.setId(OrmServicesFactory.getInstance().getOrmService(Analyte.class).insert(anTartaricAcid));
	    //Solvents:
	    Solvent slWater = new Solvent(); slWater.setName("Water");
	    slWater.setId(OrmServicesFactory.getInstance().getOrmService(Solvent.class).insert(slWater));
	    Solvent slAcn = new Solvent(); slAcn.setName("cetonitrile (MeCN, ACN)");
	    slAcn.setId(OrmServicesFactory.getInstance().getOrmService(Solvent.class).insert(slAcn));
	    Solvent slTfa = new Solvent(); slTfa.setName("trifluoroacetic acid (TFA)");
	    slTfa.setId(OrmServicesFactory.getInstance().getOrmService(Solvent.class).insert(slTfa));
	    Solvent slAmmac = new Solvent(); slAmmac.setName("ammonium acetate (AmAc)");
	    slAmmac.setId(OrmServicesFactory.getInstance().getOrmService(Solvent.class).insert(slAmmac));
	    Solvent slAmFm = new Solvent(); slAmFm.setName("ammonium formate (AmFm)");
	    slAmFm.setId(OrmServicesFactory.getInstance().getOrmService(Solvent.class).insert(slAmFm));
	    //Series heads:
	    ...
	    series1.setId(OrmServicesFactory.getInstance().getOrmService(SeriesHead.class).insert(series1));
	    SeriesSolvents serSlv1 = new SeriesSolvents();
	    serSlv1.setSolvent(slWater);
	    serSlv1.setSeriesHead(series1);
	    serSlv1.setAmount("100%");    
	    OrmServicesFactory.getInstance().getOrmService(SeriesSolvents.class).insert(serSlv1);
	    SeriesBody serBd;
	    for(int i=0;i<=25;i++) {
	    	...
	    	OrmServicesFactory.getInstance().getOrmService(SeriesBody.class).insert(serBd);
	    }
	    ...
	    series2.setId(OrmServicesFactory.getInstance().getOrmService(SeriesHead.class).insert(series2));
	    ...
	    series3.setId(OrmServicesFactory.getInstance().getOrmService(SeriesHead.class).insert(series3));
	    serSlv1 = new SeriesSolvents();
	    serSlv1.setSolvent(slWater);
	    ...
	    series4.setId(OrmServicesFactory.getInstance().getOrmService(SeriesHead.class).insert(series4));
	    serSlv1 = new SeriesSolvents();
	    serSlv1.setSolvent(slWater);
